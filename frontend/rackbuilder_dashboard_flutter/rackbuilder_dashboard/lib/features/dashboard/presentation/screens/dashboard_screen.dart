...
import "../../../correcciones/presentation/cubit/correcciones_cubit.dart";
...
import "../../../correcciones/presentation/screens/correcciones_screen.dart";
import "../../../rag/presentation/screens/rag_screen.dart";

enum DashModule { analiticas, alimentar, draco, catalogo, historial, correcciones, rag }
...
class _DashboardScreenState extends State<DashboardScreen> {
  ...
  void _loadActiveModule(BuildContext ctx) {
    switch (_module) {
      ...
      case DashModule.correcciones:
        ctx.read<CorreccionesCubit>().loadCorrecciones();
      default:
        break;
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    return MultiBlocProvider(
      providers: [
        ...
        BlocProvider(create: (_) => sl<CorreccionesCubit>()),
  ...
  Widget _content(BuildContext ctx) => Container(
    ...
    child: SingleChildScrollView(child: AnimatedSwitcher(
      ...
      child: switch (_module) {
        ...
        DashModule.correcciones => const CorreccionesScreen(key: ValueKey("correcciones")),
...
class _BottomNav extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    const items = [
      ...
      (DashModule.correcciones, Icons.psychology_alt, "Aprender"),
      (DashModule.rag,        Icons.manage_search, "RAG"),
    ];
    return Container(
