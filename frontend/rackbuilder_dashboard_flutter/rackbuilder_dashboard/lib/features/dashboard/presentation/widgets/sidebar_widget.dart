      ...
      child: Column(children: [
        Container(
          ...
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            NavButton(icon: Icons.psychology_alt, label: "Aprendizaje Continuo", active: module == DashModule.correcciones, onTap: () => onSwitch(DashModule.correcciones)),
            NavButton(icon: Icons.manage_search,  label: "Base de Conocimiento (RAG)", active: module == DashModule.rag, onTap: () => onSwitch(DashModule.rag)),
          ]),
        ),
