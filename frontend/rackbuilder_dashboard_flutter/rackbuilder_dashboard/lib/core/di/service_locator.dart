...
import '../../features/correcciones/data/datasources/correcciones_remote_datasource.dart';
import '../../features/correcciones/data/repositories/correcciones_repository_impl.dart';
import '../../features/correcciones/domain/repositories/correcciones_repository.dart';
import '../../features/correcciones/domain/usecases/list_correcciones_usecase.dart';
import '../../features/correcciones/domain/usecases/delete_correccion_usecase.dart';
import '../../features/correcciones/presentation/cubit/correcciones_cubit.dart';
...
Future<void> setupServiceLocator() async {
  ...
  // ── Correcciones (aprendizaje continuo) ──────────────────────────────────────
  sl.registerLazySingleton<CorreccionesRemoteDatasource>(
      () => CorreccionesRemoteDatasourceImpl(sl()));
  sl.registerLazySingleton<CorreccionesRepository>(
      () => CorreccionesRepositoryImpl(sl()));
  sl.registerLazySingleton(() => ListCorreccionesUsecase(sl()));
  sl.registerLazySingleton(() => DeleteCorreccionUsecase(sl()));
  sl.registerFactory(() => CorreccionesCubit(sl(), sl()));
