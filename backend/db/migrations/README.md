...
| `0011_indices_session_id.sql` | Índices sobre `session_id` en `disenos_racks` y `proyectos_pm_historial` (la consulta más frecuente del sistema, sin cubrir) | ⬜ pendiente |
